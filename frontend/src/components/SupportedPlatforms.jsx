...
const platformIcons = [
  ...
  { name: 'Reddit', text: 'Reddit', path: '/#supported-platforms', Icon: SiReddit, activeColor: 'group-hover:text-[#FF4500]' },
  { name: 'LinkedIn', text: 'LinkedIn', path: '/#supported-platforms', Icon: FaLinkedin, activeColor: 'group-hover:text-[#0A66C2]' },
  { name: 'Snapchat', text: 'Snapchat Spotlight', path: '/#supported-platforms', Icon: SiSnapchat, activeColor: 'group-hover:text-[#FFFC00]' },
  { name: 'Threads', text: 'Threads', path: '/#supported-platforms', Icon: SiThreads, activeColor: 'group-hover:text-[#000000]' },
  { name: 'Vimeo', text: 'Vimeo', path: '/#supported-platforms', Icon: SiVimeo, activeColor: 'group-hover:text-[#1AB7EA]' },
  { name: 'Twitch', text: 'Twitch (Clips)', path: '/#supported-platforms', Icon: SiTwitch, activeColor: 'group-hover:text-[#9146FF]' },
  { name: 'Dailymotion', text: 'Dailymotion', path: '/#supported-platforms', isText: true, activeColor: 'group-hover:text-[#0066DC]' },
];
